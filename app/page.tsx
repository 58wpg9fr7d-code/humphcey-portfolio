...
const projects: Project[] = [
  { id: "archmind", no: "01", name: "ArchMind", category: "检索增强 / 建筑知识工具", year: "2026", summary: "让建筑规范检索有出处，研究过程才接得住。", role: "产品设计、RAG 技术验证", shipped: "资料上传、向量检索、来源回溯、案例分析流程", skills: ["问题拆解", "检索评测", "信息架构"], demo: "https://58wpg9fr7d-code.github.io/architecture-knowledge-assistant/", image: "/projects/archmind-path-current.png", visual: "archmind" },
  { id: "weread", no: "02", name: "WeRead AI", category: "浏览器插件 / 本地工具", year: "2026", summary: "把阅读回顾和笔记沉淀放回阅读现场。", role: "产品设计、本地工具工作流", shipped: "情节节点、阅读回顾、划线整理、Obsidian 导出", skills: ["场景建模", "插件架构", "状态设计"], demo: "https://58wpg9fr7d-code.github.io/weread-ai-reading-assistant/demo/", source: "https://github.com/58wpg9fr7d-code/weread-ai-reading-assistant", image: "/projects/weread-product-page.jpg", visual: "weread" },
