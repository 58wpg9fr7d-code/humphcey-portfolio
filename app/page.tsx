...
function AnimatedHeading() {
  const lines = ["Building products", "for the in-between."];
  const [visible, setVisible] = useState(false);
  ...
  return (
    <main id="top">
      <section className="hero-reference">
        <video className="hero-video" autoPlay loop muted playsInline poster="/projects/archmind-home.png" src="https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260403_050628_c4e32401-fab4-4a27-b7a8-6e9291cd5959.mp4" />
        <div className="hero-reference-inner shell">
          <nav className="topbar liquid-glass"><a className="wordmark" href="#top">何蓬熙 <span>/ Humphcey</span></a><div className="nav-links"><a href="#work">Work</a><a href="#profile">About</a><a href="#contact">Contact</a></div><a className="nav-cta" href="#contact">Start a Conversation</a></nav>
          <div className="hero-content"><div className="hero-main"><div className="hero-kicker"><span>AI PRODUCT MANAGER</span><span>HANGZHOU · 2026</span></div><AnimatedHeading /><FadeIn delay={800}><p className="hero-intro">I turn complex questions into clear products — from the first structure to a working demo.</p></FadeIn><FadeIn delay={1200} className="hero-actions"><a className="button button-light" href="#work">Explore the work <span>↗</span></a><a className="button liquid-glass" href="#contact">Start a chat <span>↗</span></a></FadeIn></div><FadeIn delay={1400} className="hero-tag"><span>Product. Interaction. AI.</span></FadeIn></div>
        </div>
      </section>
      ...
      <section className="contact shell" id="contact"><div><span className="section-line-label">04 / CONTACT</span><h2>Have a question?<br /><span>Let&apos;s make it real.</span></h2></div><div className="contact-note"><p>正在寻找 AI 产品经理实习机会。杭州，立即到岗，每周 5 天。</p><a href="mailto:humphcey@example.com">Get in touch ↗</a></div></section>
