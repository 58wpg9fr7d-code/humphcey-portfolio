...
const projects: Project[] = [
  ...
  { id: "jingye", no: "03", name: "推理互动游戏", category: "叙事系统 / 最小可用版本", year: "2026", summary: "一场推理游戏，如何利用 AI 变成一套好玩的互动体验？", role: "从世界观与角色设定出发，搭建玩家端体验、线索释放和主持人流程。", shipped: "角色选择、房间进入、手机端剧情、线索解锁、线索板与主持人入口", skills: ["叙事结构", "信息分层", "视觉系统"], demo: "https://jingye-garden-interactive-mystery.58wpg9fr7d.workers.dev/phone", embed: "https://jingye-garden-interactive-mystery.58wpg9fr7d.workers.dev/phone", visual: "jingye" },
  ...
  { id: "social", no: "05", name: "学ai-每天学点", category: "小红书从0到1", year: "2026", summary: "0基础跨界学AI，大白话入门，日更中。", role: "账号定位、内容策略、日更运营", shipped: "账号定位、4类内容栏目、日更节奏、失败公开复盘", skills: ["账号定位", "内容策略", "数据复盘"], demo: "https://www.xiaohongshu.com/user/profile/6a741f8e0000000013030c01", visual: "social" }
];
...
function SocialMetrics(){
 return <div className="social-card">
  <div className="social-head">
   <div className="social-avatar">学</div>
   <div><b>学ai-每天学点</b><span className="social-id">小红书号 18138936356</span></div>
   <span className="social-badge">日更中</span>
  </div>
  <p className="social-pos">浙大建筑研究生 · 0 基础跨界学 AI · 大白话入门</p>
  <div className="social-grid">
   <div><b>入门科普</b><span>大白话讲清 AI 概念</span></div>
   <div><b>工具实测</b><span>真实上手使用记录</span></div>
   <div><b>前沿资讯</b><span>过滤噪音的精选</span></div>
   <div><b>思考笔记</b><span>踩坑过程公开复盘</span></div>
  </div>
  <div className="social-chips"><span>日更节奏</span><span>内容矩阵</span><span>失败选题复盘</span><span>与产品项目联动</span></div>
 </div>;
}
...
export default function Home(){
 ...
 return <main id="top"><header className="shell topbar"><a href="#top">何蓬熙 / Humphcey</a><nav aria-label="主要导航"><a href="#work">项目</a><a href="#visual">视觉表达</a><a href="#profile">关于我</a><a href="#contact">联系</a></nav></header>
